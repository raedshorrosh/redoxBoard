...
function createSelectDropdown() {
      ...
      let selectTag = {#ox_no_txt#}+': '+ '<select id='+"nameinput"+ rqm.toString()+' style="font-family: Arial; font-size: 14px; padding: 5px; border: 1px solid #ccc; border-radius: 4px;>';
...
const dropdown = document.getElementById("nameinput"+ rqm.toString());
